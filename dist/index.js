...
const { SLACK_WEBHOOK, SLACK_CHANNEL, GITHUB_REPOSITORY, GITHUB_REF, GITHUB_SERVER_URL, GITHUB_RUN_ID } = process.env;
...
function sendReleaseNotesNotification() {
    return __awaiter(this, void 0, void 0, function* () {
        const webhook = new IncomingWebhook(SLACK_WEBHOOK);
        const version = js_yaml_1.load(fs_1.readFileSync('./.version', 'utf-8'));
        yield webhook.send({
