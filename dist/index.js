...
const axios_1 = __importDefault(__webpack_require__(4814));
const errors_1 = __webpack_require__(9586);
const instrument_1 = __webpack_require__(8811);
/**
...
const packageJson = __webpack_require__(5484); // tslint:disable-line:no-require-imports no-var-requires
/**
...
module.exports = __webpack_require__(1875);
...
var utils = __webpack_require__(6252);
var settle = __webpack_require__(8474);
var buildFullPath = __webpack_require__(5520);
var buildURL = __webpack_require__(6738);
var http = __webpack_require__(8605);
var https = __webpack_require__(7211);
var httpFollow = __webpack_require__(5266).http;
var httpsFollow = __webpack_require__(5266).https;
var url = __webpack_require__(8835);
var zlib = __webpack_require__(8761);
var pkg = __webpack_require__(9697);
var createError = __webpack_require__(6725);
var enhanceError = __webpack_require__(5298);
...
var utils = __webpack_require__(6252);
var settle = __webpack_require__(8474);
var cookies = __webpack_require__(9901);
var buildURL = __webpack_require__(6738);
var buildFullPath = __webpack_require__(5520);
var parseHeaders = __webpack_require__(3275);
var isURLSameOrigin = __webpack_require__(1456);
var createError = __webpack_require__(6725);
...
var utils = __webpack_require__(6252);
var bind = __webpack_require__(8905);
var Axios = __webpack_require__(5299);
var mergeConfig = __webpack_require__(6889);
var defaults = __webpack_require__(9724);
...
axios.Cancel = __webpack_require__(4445);
axios.CancelToken = __webpack_require__(770);
axios.isCancel = __webpack_require__(6979);
...
// Expose isAxiosError
axios.isAxiosError = __webpack_require__(1524);
...
var Cancel = __webpack_require__(4445);
...
var utils = __webpack_require__(6252);
var buildURL = __webpack_require__(6738);
var InterceptorManager = __webpack_require__(734);
var dispatchRequest = __webpack_require__(2888);
var mergeConfig = __webpack_require__(6889);
...
var isAbsoluteURL = __webpack_require__(9467);
var combineURLs = __webpack_require__(3584);
...
var isCancel = __webpack_require__(6979);
var defaults = __webpack_require__(9724);
...
var utils = __webpack_require__(6252);
var normalizeHeaderName = __webpack_require__(5631);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __webpack_require__(5260);
  } else if (typeof process !== 'undefined' && Object.prototype.toString.call(process) === '[object process]') {
    // For node use HTTP adapter
    adapter = __webpack_require__(8375);
  }
  return adapter;
}
...
var debug = __webpack_require__(9340);
...
const slack_1 = __webpack_require__(568);
function run() {
        ...
        try {
            ...
            switch (template) {
                case 'build_status': {
                    ...
                    yield slack_1.sendBuildNotification(status);
                    break;
                }
                case 'release_notes': {
                    yield slack_1.sendReleaseNotesNotification();
                    break;
                }
            }
        }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.sendReleaseNotesNotification = exports.sendBuildNotification = void 0;
const { IncomingWebhook } = __webpack_require__(777);
const fs_1 = __webpack_require__(5747);
const js_yaml_1 = __webpack_require__(1917);
const path_1 = __webpack_require__(5622);
const { SLACK_WEBHOOK, SLACK_CHANNEL, GITHUB_REPOSITORY, GITHUB_REF, GITHUB_SERVER_URL, GITHUB_RUN_ID, GITHUB_WORKSPACE } = process.env;
function getSlackStatusColor(status) {
    switch (status) {
        case "success":
            return "#4dc89a";
        case "failure":
...
function sendBuildNotification(status) {
    return __awaiter(this, void 0, void 0, function* () {
        const webhook = new IncomingWebhook(SLACK_WEBHOOK);
        yield webhook.send({
            text: `*Build status for ${path_1.basename(GITHUB_REPOSITORY || '')} (${GITHUB_REF})*`,
...
exports.sendBuildNotification = sendBuildNotification;
function sendReleaseNotesNotification() {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const webhook = new IncomingWebhook(SLACK_WEBHOOK);
        const version = js_yaml_1.load(fs_1.readFileSync(`${GITHUB_WORKSPACE}/.version`, 'utf-8'));
        yield webhook.send({
            text: `*New release for ${path_1.basename(GITHUB_REPOSITORY || '')} (${GITHUB_REF})*`,
            channel: SLACK_CHANNEL,
            username: 'Release Bot',
            icon_emoji: ':package:',
            attachments: [{
                    text: (_a = version === null || version === void 0 ? void 0 : version.changes) === null || _a === void 0 ? void 0 : _a.slack,
                    color: '#0063a4'
                }]
        });
    });
}
exports.sendReleaseNotesNotification = sendReleaseNotesNotification;
